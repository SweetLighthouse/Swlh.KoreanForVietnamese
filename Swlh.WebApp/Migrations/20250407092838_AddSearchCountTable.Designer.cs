...
namespace Swlh.WebApp.Migrations
{
    ...
    [Migration("20250407092838_AddSearchCountTable")]
    partial class AddSearchCountTable
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Swlh.WebApp.Domain.Entities.KeywordSearchCount", b =>
                {
            ...
            modelBuilder.Entity("Swlh.WebApp.Domain.Entities.CommentOnWordReaction", b =>
                {
                    ...
                    b.HasOne("Swlh.WebApp.Domain.Entities.CommentOnWord", "Comment")
                        .WithMany("Reactions")
                        .HasForeignKey("CommentId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
